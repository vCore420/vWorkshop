...
src/
  ...
  resident/                  ResidentMovement.js, ResidentBehaviour.js, ResidentRenderer.js (orphaned as of Version 4 Phase 7 — see docs/RESIDENT.md), ResidentConnection.js, ResidentConversation.js, ResidentState.js, ResidentTraits.js, ResidentDials.js, ResidentContext.js, ResidentPreferences.js, PlayerPatternMemory.js, ResidentCuriosity.js, ConversationMemory.js, ResidentWorldSignals.js — see docs/RESIDENT.md. ResidentEntity.js/ResidentController.js were retired, Version 4 Phase 7 — their per-frame work now lives in beings/BeingController.js.
  world/                     WorldAwareness.js, WorldEventLog.js — the shared World Awareness layer, queried on demand by ResidentContext.buildWorldKnowledgeLine() — see docs/RESIDENT.md's own "World Awareness" section
  beings/                    ModelAssetStore.js, ModelLibrary.js, ModelLoader.js, BodyCompiler.js, BeingBehaviours.js, BeingLibrary.js, BeingInstanceStore.js, BeingMovementSystem.js, BeingController.js, BeingSpawnerSystem.js, BeingResidentStateStore.js (Version 4, Phase 7 — resident-capable Being state, see docs/BEINGS.md) — see docs/BEINGS.md
  ...
  utils/                     PlaceholderFactory (shape helpers + the shared Materials factory), ProceduralTexture (canvas-generated albedo, plus the derived normal/roughness surface maps — Version 4 Phase 10a), TextureQuality (the boot-time surface-detail tier every generator consults — see docs/PERFORMANCE.md), TextureUtils, AudioSynth, InputManager, SimpleMarkdown, math, storage, ScreenProjector, AffinityTracker
