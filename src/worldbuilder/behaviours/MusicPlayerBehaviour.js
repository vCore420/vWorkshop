 ...
 * to emit the exact same `interaction:trigger` event the music cabinet's own
 * `overlayId: "music"` already produces (see
 * `src/entities/furniture/MusicCabinet.js`). Both paths converge on the
 ...
 * closer to a music box than a full listening setup. This one opens the
 * real personal library (`docs/MUSIC.md`). A custom object can carry
 * either, matching whichever it's actually meant to be.
 */
